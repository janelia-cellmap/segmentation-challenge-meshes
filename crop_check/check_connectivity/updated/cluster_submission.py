...
paths = glob.glob(
    "/groups/cellmap/cellmap/ackermand/new_meshes/scripts/single_resolution/crop_check_updated_20241211/**/*",
    recursive=True,
)
directories = [
    p
...
while len(directories) >= 0:
    ...
    if (
        ...
        command = (
            f"bsub -n 4 -P cellmap -o /dev/null -e /dev/null meshify -n 4 {organelle}"
        )
